...
To extend any method check for the method in organizer.py and create a similar method
with name similar to the method to be extended name but without the 'default_'
prepended to it.
After creating the methods, tell fotools to use it in the commandline with the -e
or --extension argument and the value should be an importable name of the module
if the extension class name is 'Extension' else the classname prepended with a
semicolon should be appended to the module name and use the normal arguments.
